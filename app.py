...
if submit_button:
    ...
    if prediction == 1:
        ...
        st.success(f"✅ Negative (No Heart Disease) — Confidence: {max(proba)*80:.2f}%")


Did this code for me it’s only giving me negative prediction after I type in animator patient details 
